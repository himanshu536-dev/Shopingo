                        ...
                        <div className="col-md-9">
                            ...
                            <div className="row">
                                <form onSubmit={postData}>
                                    ...
                                    <div className='mb-3'>
                                        <textarea rows={4} placeholder="Answer of above question" name="answer" onChange={getInputData} className={`form-control ${show && errorMessage.answer ? 'border-danger' : 'border-dark'}`} />
