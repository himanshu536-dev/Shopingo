                ...
                <div className="container-fluid my-2">
                    <div className="row">
                        ...
                        <div className="col-md-9">
                            <h5 className='text-light bg-dark p-2 text-center'>Subcategory
                                <Link to="/admin/subcategory/create"> <i className="bi bi-plus float-end text-light "></i></Link></h5>
                            <div className="row">
                                        ...
                                        <tbody>
                                            {
                                                SubcategoryStateData.map(item => {
                                                    return <tr key={item.id}>
                                                        ...
                                                        <td><Link to={`/admin/subcategory/update/${item.id}`}><i className='btn btn-primary bi bi-pencil-square'></i></Link></td>
